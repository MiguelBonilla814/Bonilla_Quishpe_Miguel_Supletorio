...
public class AdapterTarea extends RecyclerView.Adapter<AdapterTarea.ViewHolder> {
    ...
    private int layout;
    private AdapterTarea.OnItemClickListener itemClickListener;
    private AdapterTarea.OnViewClickListener viewClickListener;
    private SparseBooleanArray checkBoxStateArray = new SparseBooleanArray();

    public AdapterTarea(List<Tarea> tareas, int layout, AdapterTarea.OnItemClickListener listener, AdapterTarea.OnViewClickListener listenerView) {
        this.tareas = tareas;
        this.layout = layout;
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final Tarea tarea, final SparseBooleanArray checkBoxStateList, final AdapterTarea.OnItemClickListener listener, final AdapterTarea.OnViewClickListener listenerView) {
